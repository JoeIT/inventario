 ...
 */
$templateDirModule = "module/manager/comprobante/";
include($pathModule."class/comprobante.class.php");
$getModule = "index.php?module=comprobante";
$objItem = new tipoComprobante();
...
$template = "index.html";
 ...
 {
    $fechaVerificar = $_REQUEST["fecha"];
    $result = $objItem->verificarComprobante($fechaVerificar);
    echo $result;
    exit;
 }
 else
