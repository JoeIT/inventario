...
{/if}
<form action="index.php?module=product" method="post" id="formItem" enctype="multipart/form-data">
{if $id eq ""}
...
{if $id eq ""}
 ...
 <div class="buttons">
   ...
   <button type="button" name="cancelar" class="negative" onclick="cancelar()" ><img src="template/images/icons/delete.png"  border="0"/>Cancelar</button>
   </div>  
</form>
{literal}
<script>
