<center>
<h2>Formulario Registro Rubro</h2>
...
<input type="hidden" name="id" id="id" value="{$item.rubroId}"/>
{/if}
<table class="formulario" align='center'  border="1" cellspacing="0" cellpadding="5" >
  <tr>
    <th colspan="2" align="center"><b>{if $action eq "new"}Nuevo {else}Editar{/if} Rubro</b></th>
    </tr>
  <tr>
