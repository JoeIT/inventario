...
<div class="buttons">
   ...
   <button type="button" name="cancelar" class="negative" onclick="location = 'index.php?module=product&cat={$item.categoryId}'" ><img src="template/images/icons/delete.png"  border="0"/>Volver</button>
   </div> 
