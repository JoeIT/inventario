...
<table  class="sofT" align='center'  border="1" cellspacing="0" cellpadding="5">
<tr>
  <td colspan="8" align="right"><a href="{$module}&action=view" class="submodal-850-450">
...
<tr>
  ...
  <th  width="261" align="center">#Items</th>
  <th  width="261" align="center">Total</th>
...
{section name=i loop=$item}
  ...
  <td>{$item[i].name} {$item[i].lastName}<br />
  {$item[i].nombreNit} {$item[i].nit}</td>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
 ...
 {sectionelse}
 <tr>
 <td colspan="8"><a href="{$module}&action=view" class="submodal-550-300">
  <img src="template/images/icons/page_add.png"  border="0"/>Nueva Venta</a></td>
 </tr>
{/section}
