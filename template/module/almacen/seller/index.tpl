...
{section name=i loop=$item}
  ...
  <td style="text-transform:uppercase">{$item[i].name} {$item[i].lastName}</td>
  <td style="text-transform:uppercase">{$item[i].nombreNit} <b>{if $item[i].nit neq ""}{$item[i].nit}{else}0{/if}</b></td>
  <td nowrap="nowrap">
