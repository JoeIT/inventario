...
<table border="1" class="formulario"  width="100%">
  ...
  <tr>
    ...
    <td width="31%"><input name="compNumero" type="hidden" id="comprobante" value="{$comprobante}"  class="numero" readonly="readonly" /><span class="comprobante">{$comprobante}</span></td>
    <td width="18%" align="right">Fecha</td>
    <td width="30%">
      <input name="compFecha" type="text" style="width:100px" id="reception" value="{$smarty.now|date_format:'%Y-%m-%d'}" readonly="readonly">
  ...
  <tr>
    ...
    <td><input name="numeroFactura" type="text" id="numeroFactura" value="{$factura}" /></td>
    <td align="right">Tipo Cambio</td>
    <td><input name="tipoCambio" type="text" id="tipoCambio" value="{$tipoCambio}"   readonly="readonly" class="numero"/> Bs.</td>
  </tr>
  <tr>
...
function showResponse(responseText, statusText)  { 
	...
	else
	{
		...
		parent.location = "{/literal}{$module}{literal}&action=recibo&id="+responseText;
					});
