...
function setReferencia()
{
	...
	if ($("#tipoComp").val()=="T")
	{
		var prov = $("#almacen option:selected").text();
	}
	else
	{	
		var prov = $("#proveedor option:selected").text();
	}
	$("#referencia").val(ref+" de "+prov);
}
...
<table border="1" class="formulario"  width="100%"   cellpadding="3">
  ...
  <tr>
    ...
    <td align="right"><div id="labelFactura"> Factura</div></td>
...
{if $type eq 1}
  ...
  <tr>
    ...
    <td width="14%" align="right"><div id="labelOrigen">Proveedor</div></td>
    <td colspan="2">  
    <div id="panelProveedor">
...
<table  class="formulario"   border="1" cellspacing="0" cellpadding="5"  align="center" width="100%" >
  ...
  <tr style="font-size:10px">
    ...
    <a href="index.php?module=product&action=view" class="submodal-650-400"> 
