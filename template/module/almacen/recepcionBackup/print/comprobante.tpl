...
<center>
  ...
  <table border="1" cellspacing="0" cellpadding="5" width="90%" style="border: 1px #000 solid; border-collapse:collapse; font-family: Arial;font-size: 9px; {if $pagina neq $paginas}page-break-after:always;{/if}">
