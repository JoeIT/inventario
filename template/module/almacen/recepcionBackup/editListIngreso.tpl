...
<table  class="formulario"   border="1" cellspacing="0" cellpadding="3" width="100%"  >
  ...
  <tr  class="{$fila}"  onMouseOver="this.className='lista3'; return true;" onMouseOut="this.className='{$fila}'; return true;">
   ...
   {else}   {$item[i].codebar}
    ...
    {if  $USER_ROL eq 1}
    <td align="right"><input type="text" class="numero"  name="precioUnitario[{$item[i].ingresoId}]" onchange="calcular({$smarty.section.i.index})" id="precio{$smarty.section.i.index}"  value="{$item[i].priceReal|number_format:2:'.':''}"  /></td>
