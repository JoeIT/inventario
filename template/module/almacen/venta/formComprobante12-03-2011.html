...
<script type="text/javascript">
	...
	function fill(thisValue,descripcion,cantidad,costo,unidad,precioVenta,precioDolar) {
...
<table border="1" class="formulario"  width="100%">
  ...
  <tr>
    ...
    <td><input name="venta[numeroFactura]" type="text" id="numeroFactura" value="" /></td>
    <td align="right">Tipo Cambio</td>
    <td><input name="item[tipoCambio]" type="text" id="tipoCambio" value="{$tipoCambio}"   readonly="readonly" class="numero"/>Bs. A la fecha:<div id="tipoCambioLabel" style="display:inline">[{$lastUpdate}]</div></td>
  </tr>
  <tr>
