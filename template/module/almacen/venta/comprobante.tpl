...
<table id="lista" class="sofT"   border="1" cellspacing="0" cellpadding="5"  >
  ...
  <tr>
    ...
    <td class="helpHed">&nbsp;</td>
    <td class="helpHed">&nbsp;</td>
    <td colspan="5" align="center" class="venta" width="50">Venta Bs</td>
  ...
  <tr>
    ...
    <td class="helpHed" widtd="50" align="center">Precio <br />Unit.</td>
    <td class="helpHed" widtd="50" align="center">Total<br /> Parcial</td>
    <td class="helpHed" widtd="50" align="center">%<br /> Descuento</td>
    <td class="helpHed" widtd="50" align="center">Total<br /> Descuento</td>
    <td class="helpHed" widtd="50" align="center">Total<br /> Venta</td>
     {if $typeUser eq "root"}
  ...
  {sectionelse}
  <tr><td colspan="17">No se registraron datos</td>
  </tr>
  {/section}
  {if $total.total neq ""}
  <tr>
          ...
          <td align="right">&nbsp;</td>
          <td align="right">{$total.totalParcial|number_format:2:'.':','}</td>
          <td align="right">&nbsp;</td>
          <td align="right">{$total.totalDescuento|number_format:2:'.':','}</td>
