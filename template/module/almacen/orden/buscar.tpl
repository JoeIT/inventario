...
<br />
<center><div class="titulo">Items disponibles</div></center>
<table   width="98%" class="formulario" align='center'  border="1" cellspacing="0" cellpadding="5"   >
   <thead>
   <tr>
     <th>&nbsp;</th>
    <th>Codigo</th>
  ...
  <tr>
    ...
    <td align="left"><input type="text" name="cantidad[{$item[i].productId}]" id="cantidad{$smarty.section.i.index}" class="numero"  value=""  
	...
	{sectionelse}
    	<tr><td colspan="10">Por favor seleccionar familia, rubro o introducir el codigo del articulo en el buscador de articulos.</td>
        </tr>
  {/section}
  </tbody>
  <TFOOT>
...
function showResponse(responseText, statusText)  { 
	...
	{
		jConfirm('Datos registrados \n Presione <b>OK,</b> Para agregar mas Items \n Presione <b>Cancel,</b> Para salir del formulario \n', 'Confirmacion', function(r) {
   		if (r)
