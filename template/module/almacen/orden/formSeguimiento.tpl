...
<input type="hidden" name="action" value="addSeg" />
<table class="formulario" align='center'  border="1" cellspacing="0" >
  <tr>
    <th colspan="2" scope="row" >SEGUIMIENTO ORDEN DE COMPRA</th>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="text" name="item[dateEvent]" id="despacho"  value="" readonly="readonly"/>
  ...
  <tr>
    <td colspan="2" scope="row"><textarea name="item[description]" id="description" style="width:98%"></textarea></td>
  </tr>
  <tr>
...
function showRequest(formData, jqForm, op) { 
	...
	{
		jAlert('Ingrese fecha Seguimiento ', 'Alerta', function() {
		$("#despacho").focus();	
					});
		return false;
	}
