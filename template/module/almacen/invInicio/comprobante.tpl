...
<input name="id" type="hidden"  value="{$recibo.itemId}" />
  ...
  <a href="#" onclick="imprimirHoja('{$module}&action=viewRecep&id={$recibo.itemId}&type=2')" title="Imprimir">    
...
<table width="90%" border="0" class="zebra" cellspacing="0" align="center">
  ...
  <tr>
    ...
    <td>{$recibo.tipoCambio} Bs.
    <input type="hidden" value="{$recibo.tipoCambio}" name="tipoCambio" />
    </td>    
 ...
 <tr><td colspan="10">No se tiene datos registrados</td></tr>
  ...
  <tfoot>
   <tr>
          ...
          <td align="right"><b>{*$totalBs|number_format:2:'.':','*}{$montoTotal|number_format:2:'.':','}</b></td>
          <td align="right" class="dolar">&nbsp;</td>
          <td align="right" class="dolar"><b>{*$totalDolar|number_format:2:'.':','*}{$montoTotalDolar|number_format:2:'.':','}</b></td>
          <td align="center">&nbsp;</td>
        </tr>
