...
{  
	...
	url = 'index.php?module=mantenimiento&tipoCambioMantenimiento='+tipocambio+'&fechaComprobante='+fecha;
	location = url;
...
<tr>
  <td>Buscar por:
    <input type="text" name="codigo" id="codigo"  value="{$codigo}" wid/> 
    <br /><small>Buscar por: codigo, categoria, nombre, color</small>
...
<table border="1" class="formulario"  width="100%" align="center">
  <tr>
    <th colspan="4">Comprobante Mantenimiento</th>
  </tr>
  <tr>
...
<input name="item[comprobante]" type="hidden" id="numeroComprobante" value="{$comprobante}" /></td>
    ...
    <td width="44%" nowrap="nowrap">  <input name="fechaComprobante" type="text" style="width:100px" id="fechaComprobante" value="{$fechaComprobante}" readonly="readonly">
    </label>
      ...
      <script type="text/javascript">
                  new Calendar({
                          ...
                          onSelect: function() {
                                  ...
                                  this.hide();
								  getTipoCambio( $('#fechaComprobante').val(),"test");
                          }
                  });
...
<thead>
  ...
  <tr>
    <td colspan="6">&nbsp;</td>
    <td colspan="3" align="center" bgcolor="#EEFDB0"><strong>Cantidad</strong></td>
  ...
  <tr class="child-row{$numItem}">
    ...
    <td align="right" bgcolor="#EEFDB0">{if $item[i].tipoTrans eq "I"}{$item[i].amount|number_format:2:'.':','}{/if} </td>
    <td align="right" bgcolor="#EEFDB0"> {if $item[i].tipoTrans eq "S"}{$item[i].amount|number_format:2:'.':','}{/if}</td>
...
<tr  style="border-bottom:1px #000 solid;"  >
           ...
           <td align="right">&nbsp;</td>
           <td align="right">{if $valorActualizacion|commify:2 neq 0}{$valorSaldo/$item[i].amountSaldo|commify:2}{/if}</td>
           <td align="right">
