...
var gPopFrame = null;
var gReturnFunc;
var gPopupIsShown = null;
var gDefaultPage = baseurl+"system/resources/js/submodal/loading.html";
		...
		'<div id="popupInner">' +
			'<div id="popupTitleBar">' +
				...
				'<div id="popupControls">' +
					'<img src="'+baseurl+'system/resources/img/close.png" onclick="closeWindow();" id="popCloseBox" height="16"/>' +
				'</div>' +
			'</div>' +
...
function centerPopWin(width, height) {
	if (gPopupIsShown == true) {
		...
		//alert(scTop);
		gPopupMask.style.top = scTop + "px"; // johan
	}
}
