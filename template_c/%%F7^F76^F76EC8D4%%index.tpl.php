<?php /* Smarty version 2.6.26, created on 2012-10-16 09:38:54
         compiled from module/manager/family//index.tpl */ ?>
<center>
...
&action=new" class="submodal"><img src="template/images/icons/page_add.png"  border="0"/>Nueva Clasificacion de Familia</a></td>
  </tr>
  <tr>
...
&action=view&id=<?php echo $this->_tpl_vars['item'][$this->_sections['i']['index']]['itemId']; ?>
" title="Editar" class="submodal">
    <img src="template/images/icons/page_edit.png"  border="0"/></a>
      <a href="#"  onclick="deleteItem('module=family&action=delItem&id=<?php echo $this->_tpl_vars['item'][$this->_sections['i']['index']]['itemId']; ?>
')" title="Eliminar">
