<?php /* Smarty version 2.6.26, created on 2013-07-24 12:34:54
         compiled from module/almacen/invInicio/form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'module/almacen/invInicio/form.tpl', 214, false),)), $this); ?>
...
<h2>Formulario Comprobante de Inventario Inicial</h2>
...
" />
   ...
   <button type="button" name="cancel" class="negative" onclick="cancelarRegistro('./index.php?module=invInicio')" > <img src="template/images/icons/delete.png"  border="0"/>Cancelar
...
function showResponse(responseText, statusText)  { 
	...
	location = "index.php?module=invInicio&action=viewRecep&id="+responseText;
}
