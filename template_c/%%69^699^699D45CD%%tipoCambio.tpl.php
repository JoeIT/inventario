<?php /* Smarty version 2.6.26, created on 2012-12-12 07:48:45
         compiled from tipoCambio.tpl */ ?>
...
<table class="search" align='center'  border="0" >
  ...
  <tr>
    ...
    <td align="left">
    <input type="text" name="fecha" id="inicio" value="<?php echo $this->_tpl_vars['fecha']; ?>
"  readonly="readonly" style="width:70px"/>
  ...
  <tr>
    ...
    <td><input type="text" name="tipoCambio" id="tipoCambio" class="numero" value="<?php echo $this->_tpl_vars['tc']; ?>
" /> 
      <strong>Bs.</strong>
      </td>
  </tr>
