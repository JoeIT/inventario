<?php /* Smarty version 2.6.26, created on 2013-02-16 11:36:26
         compiled from module/manager/unidad//index.tpl */ ?>
<?php echo '
<script>
function delItem()
{
...
<table summary="Lista de productos"  class="sofT" align='center'  border="1" cellspacing="0" cellpadding="5"  >
  <tr>
    <td colspan="5" align="right"><a href="<?php echo $this->_tpl_vars['module']; ?>
&action=new" class="submodal"><img src="template/images/icons/page_add.png"  border="0"/>Nueva Unidad de Medida</a></td>
  </tr>
  <tr>
...
&action=view&id=<?php echo $this->_tpl_vars['item'][$this->_sections['i']['index']]['unidadId']; ?>
" title="Editar" class="submodal-400-250">
    <img src="template/images/icons/page_edit.png"  border="0"/></a>
      <a href="#"  onclick="deleteItem('module=unidad&action=delItem&id=<?php echo $this->_tpl_vars['item'][$this->_sections['i']['index']]['unidadId']; ?>
')" title="Eliminar">
