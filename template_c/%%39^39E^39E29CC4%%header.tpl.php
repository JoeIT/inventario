<?php /* Smarty version 2.6.26, created on 2013-08-22 10:30:31
         compiled from module/almacen/reporte/resumen/header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'module/almacen/reporte/resumen/header.tpl', 7, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ...
 Al: <?php echo ((is_array($_tmp=$this->_tpl_vars['fin'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%Y") : smarty_modifier_date_format($_tmp, "%d-%m-%Y")); ?>
	...
	<br />(En <?php if ($this->_tpl_vars['moneda'] == 0): ?><?php echo $this->_config[0]['vars']['monedaBolivia']; ?>
